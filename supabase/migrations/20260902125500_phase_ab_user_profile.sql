...
-- This migration is idempotent because the Lovable Cloud database was prepared before the code was committed.
...
begin
  if not exists (
    ...
    alter table public.profiles add constraint profiles_minimum_age
...
begin
  insert into public.profiles (
    id, full_name, email, phone, country, address, date_of_birth
  ) values (
    new.id,
